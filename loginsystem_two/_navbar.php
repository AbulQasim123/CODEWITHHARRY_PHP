...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		...
		<div class="collapse navbar-collapse" id="navbarcontent">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item">
					<a href="Logout.php" class="nav-link">Louout</a>
				</li>
			</ul>
			<form action="" class="form-inline my-2 my-lg-0">
				<input type="search" name="search" id="search" placeholder="Search" class="form-control mr-sm-2">
	...
	<script src="bootstrap-4.0.0-dist\js\mypopper.js"></script>
